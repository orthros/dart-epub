...
class PackageReader {
  static Future<EpubPackage> ReadPackageAsync(Archive epubArchive, String rootFilePath) async {
      ...
      xml.XmlDocument containerDocument =xml.parse(UTF8.decode(rootFileEntry.content));
      String opfNamespace = "http://www.idpf.org/2007/opf";
      xml.XmlElement packageNode = containerDocument.findElements("package", namespace: opfNamespace)
      ...
      xml.XmlElement metadataNode = packageNode.findElements("metadata", namespace: opfNamespace)
                                         .firstWhere((xml.XmlElement elem) => elem != null);
      ...
      xml.XmlElement manifestNode = packageNode.findElements("manifest", namespace: opfNamespace)
                                         .firstWhere((xml.XmlElement elem) => elem != null);
      ...
      xml.XmlElement spineNode = packageNode.findElements("spine", namespace: opfNamespace)
                                      .firstWhere((xml.XmlElement elem) => elem != null);
      if (spineNode == null)
